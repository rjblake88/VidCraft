        ...
        <div className="lg:col-span-1 space-y-6">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground">{actor.description}</div>
                        <div className="flex items-center space-x-2">
                          <Star className="w-3 h-3 text-yellow-500" />
                          <span className="text-xs">{actor.quality_rating}</span>
                          <span className="text-xs text-muted-foreground">• {actor.usage_count} uses</span>
                        </div>
                      </div>
                    )
                  })()}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select the perfect voice for your video</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <SelectItem key={voice.id} value={voice.id}>
                      <div className="flex items-center justify-between w-full">
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">{voice.accent} • {voice.style}</div>
                        </div>
                        <div className="flex items-center ml-4">
                          <Star className="w-3 h-3 text-yellow-500 mr-1" />
                          <span className="text-xs">{voice.quality_rating}</span>
                        </div>
                      </div>
                    </SelectItem>
                  ))}
                    ...
                    return (
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <Star className="w-3 h-3 text-yellow-500" />
                          <span className="text-xs">{voice.quality_rating}</span>
                          <span className="text-xs text-muted-foreground">• {voice.usage_count} uses</span>
                        </div>
                      </div>
                    )
                  })()}
          ...
          <Card>
            <CardContent className="pt-6">
              <Button 
                ...
                disabled={isGenerating || !script || !selectedModel || !selectedActor || !selectedVoice}
                className="w-full"
                size="lg"
              >
                {isGenerating ? (
